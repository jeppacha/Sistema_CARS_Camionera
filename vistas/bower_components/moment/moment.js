...
//var basicRfcRegex = /^((?:Lun|Mar|Mie|Jue|Vie|Sab|Dom),?\s)?(\d?\d\s(?:Ene|Feb|Mar|Apr|May|Jun|Jul|Ago|Sep|Oct|Nov|Dic)\s(?:\d\d)?\d\d\s)(\d\d:\d\d)(\:\d\d)?(\s(?:UT|GMT|[ECMP][SD]T|[A-IK-Za-ik-z]|[+-]\d{4}))$/;
...
function configFromRFC2822(config) {
    ...
    if (match) {
        ...
        if (match[1]) { // day of week given
            ...
            //var momentDay = ['Dom','Lun','Mar','Mie','Jue','Vie','Sab'][momentDate.getDay()];
