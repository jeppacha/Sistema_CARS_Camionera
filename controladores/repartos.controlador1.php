					...
					if($deliv === 1){
						...
						if($respuesta == "ok"){
							...
							if($respuestacar == "ok"){
								...
								$mirarinde1cc = ModeloRepartos::mdlMiraRinde($tablahrep, $itemhrep1, $valorh1, $itemhrep2, $valorh2);

								if($mirarinde1cc["guiarend"] == null){

									$guias = 1;

								}else{

									if($mirarinde1cc["guiarend"]<$mirarinde1cc["cantg"]){

										$guias = ($mirarinde1cc["guiarend"]+1);
			...
			if(strcmp($_POST["entregacc"],"no")==0){
				...
				if($_POST["txtDescripcion"] == ""){
					...
					if($respuesta == "ok"){
						...
						$mirarinde0cc = ModeloRepartos::mdlMiraRinde($tablahrep, $itemhrep1, $valorh1, $itemhrep2, $valorh2);

						if($mirarinde0cc["guiarend"] == null){

							$guias = 1;

						}else{

							if($mirarinde0cc["guiarend"]<$mirarinde0cc["cantg"]){

								$guias = ($mirarinde0cc ["guiarend"]+1);
						...
						if($actualizahrep != "ok"){
							...
							$tablag="rindeguia";
							$itemg1 = "codoff";
							$valorg1 = $_POST["sucuradm"];
							$itemg2 = "repnro";
							$valorg2 = $_POST["repnrocc"];
							$itemg3 = "nguia";
							$valorg3 = $_POST['editarGuiasc'];

							$revisaguia = ModeloRepartos::mdlRevisaGuia($tablag,$itemg1,$valorg1,$itemg2,$valorg2,$itemg3,$valorg3);

							if($revisaguia != ""){

								$datag = array("codoff" => $_POST["sucuradmsc"],"repnro" => $_POST["repnrosc"],"nguia" => $_POST["editarGuiasc"],"entrega" => $deliv);

								$actualizag = ModeloRepartos::mdlActualizaGuias($tablag,$datag);
								...
								$ingresag = ModeloRepartos::mdlIngresaGuias($tablag,$datag);
					...
					if($_POST["txtSinCliente"] == ""){
						...
						if($respuestasc == "ok"){
							...
							if($actualizahrep != "ok"){
								...
								$tablag="rindeguia";
								$itemg1 = "codoff";
								$valorg1 = $_POST["sucuradmsc"];
								$itemg2 = "repnro";
								$valorg2 = $_POST["repnrosc"];
								$itemg3 = "nguia";
								$valorg3 = $_POST['editarGuiasc'];
